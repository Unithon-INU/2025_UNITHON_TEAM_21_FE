    ...
    return (
        <Layout>
            ...
            <View className="flex-row space-x-2 mb-3 pt-[20px] pb-[px] pl-[1px] gap-[8px]">
                {/* 전체 탭 */}
                <TouchableOpacity className="bg-main-color px-2 py-1 rounded-full">
                    <Text className="text-white font-inter font-bold">전체</Text>
                </TouchableOpacity>

                {/* 안 읽은 채팅방 탭 */}
                <TouchableOpacity className="border border-[#D5D5D5] px-2 py-1 rounded-full">
                    <Text className="text-black font-inter font-bold">안 읽은 채팅방</Text>
                </TouchableOpacity>
            </View>
